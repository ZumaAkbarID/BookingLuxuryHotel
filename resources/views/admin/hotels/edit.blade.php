                ...
                <form method="POST" action="{{ route('admin.hotels.update', $hotel) }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" required
                            autofocus autocomplete="name" value="{{ $hotel->name }}" />
                    ...
                    <div class="mt-4">
                        ...
                        <select name="city_id" id="city_id"
                            ...
                            @foreach ($cities as $city)
                                <option @if ($city->id == $hotel->city_id) selected @endif value="{{ $city->id }}">
                                    {{ $city->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="country_id" id="country_id"
                            ...
                            @foreach ($countries as $country)
                                <option @if ($country->id == $hotel->country_id) selected @endif value="{{ $country->id }}">
                                    {{ $country->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="link_gmaps" class="block mt-1 w-full" type="text" name="link_gmaps"
                            required autofocus autocomplete="link_gmaps" value="{{ $hotel->link_gmaps }}" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="star_level" class="block mt-1 w-full" type="number" name="star_level"
                            required autofocus autocomplete="star_level" value="{{ $hotel->star_level }}" />
